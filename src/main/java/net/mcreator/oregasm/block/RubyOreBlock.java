...
package net.mcreator.oregasm.block;
...
public class RubyOreBlock extends OregasmModElements.ModElement {
	@ObjectHolder("oregasm:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(OregasmModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(OregasmItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 3)).range(12).square().func_242731_b(1));
	}
}
